namespace BTMV.Common
{
    public class BTMV
    {
        ...
        public const string UserExistsMsg = "User with this Email Already Exists.";
        public const string RegistrationSuccessMsg = "Registration Successful.";
        public const string UserNotFoundMsg = "User Not Found.";
        public const string InvalidCredentialsMsg = "Invalid Credentials";
        public const string LoginSuccessMsg = "Login Successful";
        public const string ProfileUpdateSuccessMsg = "Your profile is updated successfully.";
