...
var CommonModalTriggerDirective = (function () {
    ...
    CommonModalTriggerDirective.prototype.ngOnInit = function () {
        var _this = this;
        this.el.addEventListener('click', function (e) {
            _this.$('#common-modal').modal({});
        });
    };
    CommonModalTriggerDirective = __decorate([
        core_1.Directive({
    ...
    return CommonModalTriggerDirective;
}());
exports.CommonModalTriggerDirective = CommonModalTriggerDirective;
//# sourceMappingURL=commonModalTrigger.directive.js.map